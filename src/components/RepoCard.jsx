  ...
  return (
    <div className="card">
      <div className="flex items-start justify-between">
        ...
        <span className="inline-flex items-center gap-1 whitespace-nowrap rounded-full bg-gray-100 px-2 py-1 text-xs text-gray-600 shrink-0 overflow-hidden">
          ...
          <span className="leading-none tabular-nums">{repo.stargazers_count ?? 0}</span>
        </span>
      </div>
